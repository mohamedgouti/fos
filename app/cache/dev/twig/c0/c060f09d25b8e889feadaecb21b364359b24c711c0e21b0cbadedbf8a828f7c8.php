...
class __TwigTemplate_1bffa59cae03fb65f138a608b031f4908b724df0860d5b08a80ca76d3954eb6b extends Twig_Template
{
    ...
    ";
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 197
                echo "                ";
                echo $context["__internal_a31beb56abba4ef9c7526f4694dcb8d47d3de812d5e8c134ada9f0bb4b64ce9d"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "data", array()), "forms_by_hash", array()));
                echo "
            ";
            }
            $_parent = $context['_parent'];
...
{% macro form_tree_details(name, data, forms_by_hash) %}
    ...
    {% endfor %}
{% endmacro %}
", "WebProfilerBundle:Collector:form.html.twig", "C:\\wamp\\www\\fos\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views/Collector/form.html.twig");
    }
}
